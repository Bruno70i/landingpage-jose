...
declare function useRendererManager({
  ...
  canBeInvalidated: vue0.ComputedRef<boolean>;
...
declare function useEventManager({
  ...
  onPointerMissed: _vueuse_core0.EventHookOn<PointerEvent<MouseEvent> & Event<"click", Object3D<Object3DEventMap & PointerEventsMap>>>;
};
//#endregion
...
declare const __VLS_export$1: <T extends TresObjectMap>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_expose?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
...
declare const useGraph: (object: MaybeRef$1<TresObject | undefined>) => vue0.ComputedRef<TresObjectMap | undefined>;
//#endregion
...
interface TresCanvasProps extends RendererOptions {
  /**
...
declare const __VLS_export: __VLS_WithSlots<vue0.DefineComponent<TresCanvasProps, {
  context: vue0.ShallowRef<TresContext | null, TresContext | null>;
  dispose: () => void;
...
}, string, vue0.PublicProps, Readonly<TresCanvasProps> & Readonly<{
